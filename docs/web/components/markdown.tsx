                ...
                renderers={{
                    ...
                    heading: props => {
                        switch (props.level) {
                            ...
                            case 2:
                                return <h2 className="text-2xl font-normal mt-16 mb-4 text-gray-900 leading-none" {...props} />
                            case 3:
                                return <h3 className="text-xl font-medium mt-12 mb-3 text-gray-900 leading-tight" {...props} />
