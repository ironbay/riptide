        ...
        <div className="overflow-y-visible w-1/5">
            <div className="scrolling-touch h-auto relative sticky top-0">
                ...
                <div className="h-screen overflow-y-scroll pt-12 text-gray-600">
                    ...
                    <Doc href="/docs/[...doc]" as="/docs/setup">Setup</Doc>
                    <Doc href="/docs/[...doc]" as="/docs/inspiration">Inspiration</Doc>
                    <Doc href="/docs/[...doc]" as="/docs/caveats">Caveats</Doc>

                    <div className="h-12" />
                    <Header>Core Concepts</Header>
                    <Doc href="/quick-start">Mutations</Doc>
                    <Doc href="/quick-start">Queries</Doc>
                    <Doc href="/quick-start">Interceptors</Doc>
...
function Doc(props) {
    ...
    return (
        <div className="mt-4">
            <Link {...props}>
                <a className={`duration-200 transition-all text-sm font-500 hover:text-black ${active && 'text-blue-500'}`} >
                    {props.children}
                </a>
            </Link>
        </div>
